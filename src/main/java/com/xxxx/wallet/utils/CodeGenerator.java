...
public class CodeGenerator {
    ...
    // 生成的代码放到哪个工程中
    private static String PROJECT_NAME = "wallet";

    // 数据库名称
    private static String DATABASE_NAME = "shixi";

    // 子包名
    private static String MODULE_NAME = "wallet";
